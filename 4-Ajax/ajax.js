    ...
    function getabout(){
        ...
        xmlhttp.open("GET","about.html"); // it setup url using get method
        xmlhttp.send(); // it sent request to above generated url
    ...
    function getcontact(){
      var xmlhttp = new XMLHttpRequest(); // a built in class name
        // it creating object of class
        xmlhttp.open("GET","contact.html"); // it setup url using get method
        xmlhttp.send(); // it sent request to above generated url
  ...
  function json2(){
    var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
            var cityArray = JSON.parse(this.responseText); // json to array
  ...
  function json3(){
    var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
            var productArray = JSON.parse(this.responseText); // json to array
        ...
        xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
            ...
            dataArray.map((company, index)=>{
              ...
              data += "<td>" + company.sales + "</td>";
              data += "</tr>";
            }) // end of map()
            var thead = "<table align='center' cellpadding='10' border='1'>";
            thead += "<tr> <th>id</th> <th>Name</th> <th>Employee</th> <th>City</th> <th>Area</th> <th>Sales</th> </tr>";
